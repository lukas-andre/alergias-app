...
export const adminTranslations = {
  ...
  eNumbers: {
    ...
    // Delete dialog
    deleteTitle: "¿Eliminar número E {code}?",
    deleteDesc: "Esta acción no se puede deshacer. Esto eliminará permanentemente",
    deleteDescSuffix: "de la base de datos.",
    deleteWarning: "Advertencia: Este número E está vinculado a {count} alérgeno(s).",
  },
  ...
  dictionaries: {
    ...
    editAllergen: "Editar Alérgeno",
    createAllergen: "Crear Alérgeno",
    updateAllergen: "Actualizar Alérgeno",
    updateAllergenDesc: "Actualiza la información del alérgeno a continuación.",
    addAllergenDesc: "Agrega un nuevo alérgeno al diccionario.",
    ...
    updateDiet: "Actualizar Dieta",
    updateDietDesc: "Actualiza la información de la dieta a continuación.",
    addDietDesc: "Agrega una nueva dieta al diccionario.",
    ...
    editIntolerance: "Editar Intolerancia",
    createIntolerance: "Crear Intolerancia",
    updateIntolerance: "Actualizar Intolerancia",
    updateIntoleranceDesc: "Actualiza la información de la intolerancia a continuación.",
    addIntoleranceDesc: "Agrega una nueva intolerancia al diccionario.",
    ...
    // Synonyms
    editSynonym: "Editar Sinónimo",
    createSynonym: "Crear Sinónimo",
    updateSynonym: "Actualizar Sinónimo",
    updateSynonymDesc: "Actualiza la información del sinónimo a continuación.",
    addSynonymDesc: "Agrega un nuevo sinónimo para coincidencias de alérgenos.",
    synonymCreated: "Sinónimo \"{surface}\" creado exitosamente",
    synonymUpdated: "Sinónimo \"{surface}\" actualizado exitosamente",
    synonymFailedSave: "Error al guardar sinónimo",
    synonymAlreadyExists: "El sinónimo ya existe",
    // Common fields
    fieldKey: "Clave",
    fieldKeyPlaceholderAllergen: "ej., milk, gluten, peanuts",
    fieldKeyPlaceholderDiet: "ej., vegetarian, vegan, keto",
    fieldKeyPlaceholderIntolerance: "ej., lactose, fructose, histamine",
    fieldKeyDesc: "Identificador único en minúsculas (no se puede cambiar después de la creación)",
    fieldName: "Nombre (Español)",
    fieldNamePlaceholderAllergen: "ej., Leche, Gluten, Maní",
    fieldNamePlaceholderDiet: "ej., Vegetariano, Vegano, Keto",
    fieldNamePlaceholderIntolerance: "ej., Lactosa, Fructosa, Histamina",
    fieldNameDesc: "Nombre para mostrar en español (variante chilena)",
    fieldSynonyms: "Sinónimos",
    fieldSynonymsPlaceholderAllergen: "ej., lácteos, productos lácteos",
    fieldSynonymsPlaceholderIntolerance: "ej., intolerancia a la lactosa",
    fieldSynonymsDesc: "Nombres alternativos para coincidencias (presiona Enter para agregar)",
    fieldNotes: "Notas (opcional)",
    fieldNotesPlaceholderAllergen: "Información adicional sobre este alérgeno...",
    fieldNotesPlaceholderIntolerance: "Información adicional sobre esta intolerancia...",
    fieldNotesDesc: "Notas internas de referencia",
    fieldDescription: "Descripción (opcional)",
    fieldDescriptionPlaceholderDiet: "Breve descripción de este tipo de dieta...",
    fieldDescriptionDesc: "Descripción orientada al usuario de la dieta",
    fieldAllergen: "Alérgeno",
    selectAllergen: "Selecciona un alérgeno",
    selectAllergenDesc: "Selecciona a qué alérgeno pertenece este sinónimo",
    cannotChangeAllergen: "No se puede cambiar el alérgeno después de la creación",
    ...
    weightLow: "1 - Baja prioridad",
    weightMedium: "2 - Prioridad media",
    weightHigh: "3 - Alta prioridad",
    ...
    // Delete dialogs
    deleteItemTitle: "¿Eliminar {type}?",
    deleteItemDesc: "Esta acción no se puede deshacer. Esto eliminará permanentemente el",
    deleteItemDescSuffix: "de la base de datos.",
    deleteItemWarning: "Advertencia: Esto puede afectar perfiles de usuario que referencien este {type}.",
    // Table
    colKey: "Clave",
    colName: "Nombre",
  ...
  settings: {
    ...
    never: "Nunca",
    // Messages
    settingUpdated: "Configuración \"{key}\" actualizada exitosamente",
    settingFailedUpdate: "Error al actualizar configuración",
    ...
    // Dialog
    editSettingTitle: "Editar Configuración: {key}",
    editSettingDesc: "Actualiza el valor y descripción de esta configuración de aplicación.",
    ...
    toggleDesc: "Activar o desactivar esta configuración",
    booleanValue: "Valor booleano (verdadero/falso)",
  ...
  audit: {
    ...
    // Detail Dialog
    entryDetails: "Detalles de Entrada de Auditoría",
    changesMade: "Cambios realizados en {table} el {date}",
    table: "Tabla:",
    rowId: "ID de Fila:",
    changedBy: "Modificado Por:",
    changedAt: "Modificado El:",
    newData: "Nuevos Datos:",
    deletedData: "Datos Eliminados:",
    noData: "Sin datos",
    changes: "Cambios ({count} campos modificados)",
    noChanges: "No se detectaron cambios de campos",
    modified: "Modificado",
    oldValue: "Valor Anterior:",
    newValue: "Valor Nuevo:",
    unknownAction: "Tipo de acción desconocido",
